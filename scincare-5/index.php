    ...
    <div class="row">
            ...
            <div class="upper-row">
                ...
                <div class="fit-date ng-binding">
                    <script language="Javascript">
                        ...
                        // -->
                    </script>Tuesday, July 14, 2015 <span>in Anti-Aging</span>
                </div>
            </div>
        </div>
        <div class="col-md-12" style="margin-top:10px;margin-bottom:10px;border-bottom:#ff0000 solid 4px;">
            <h2 class="main-title" style="margin-top:0;margin-bottom:0;padding:0;">
                70 Year Old Grandmas Look 40 Again: You Will Not Believe Their Transformations!</h2>
        </div>
    </div>
    <div class="row last-row">
        <div class="col-md-7" id="mainText" style="text-align:justify;">
            <div style="height: 303px;" class="sticky-wrapper" id="sidebar-sticky-wrapper"><div id="sidebar-sticky-wrapper" class="sticky-wrapper is-sticky" style="height: 12px;"><div id="sidebar" class="stickySocial" style="position: fixed; top: 30px;">
                    </div></div></div>
...
<a href="<?php echo $OFFER1; ?>" target="_blank" style="color:#124878;">656</a>
            ...
            <p>Instead of throwing away precious dollars on expensive anti-aging skin Creams that make big promises and don't work, one reader has discovered a skin product that erases years off her face for only a few dollars. Read on to find out how it works!
            </p>
            ...
            <p>
                ...
                <img alt="" src="img/eyes3.jpg" height="150px" width="" style="float:left;padding-right: 20px">After 14 days, not only had all my doubts and skepticism absolutely vanished - SO DID MY WRINKLES!
            </p>
            <p>
            ...
            <p>
                After the 2 weeks, my skin not only stayed that way, it actually improved every day until it became as beautiful and radiant as it was 20 years ago. <strong>By this point, all my friends and family were shocked. They couldn't believe the difference, and were convinced I was lying about not getting botox!</strong>
            </p>
            <h1>Will This Work For You?</h1>
            <p>
                There are plenty of skincare gimmicks out there, and most of them are ridiculously expensive. With so many options it's only natural for you to be skeptical about the results, and so I challenge you to do what I did: <strong>try it for yourself!</strong> Conduct your own study and see the incredible results in your mirror at home. <strong>You won't believe YOUR before and after!</strong>
            </p>
            <p>
...
<img class="alignleft" style="padding-bottom:10px;padding-left:10px" alt="" src="img/iconRedArrow.png" height="40" width="35"></span>
            ...
            <p></p>
            <p>
                We rarely do these write ups because the reality is that there is just a bunch of rubbish out there claiming to be that next big anti-aging breakthrough. But this was just too good to keep away from the public.
            </p>
            <p>
            ...
            <div id="comments">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        I have not been able to find this in stock for 2 months! Thanks for the free trial, that will save me. Thanks Fit Mom Daily! Love, Cara
                    </div>
                </div>
                <div class="media">
                    <a class="pull-left" href="<?php echo $OFFER1; ?>">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        My daughter and I have wrinkle issues. I really hope this is the answer. Thank you Fit Mom Daily.
                    </div>
                </div>
                <div class="media">
                    <a class="pull-left" href="<?php echo $OFFER1; ?>">
                    ...
                    <div class="media-body">
                        ...
                        My husband and I both need to look younger because we are going to be seeing family we haven’t seen in 25
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        are managed to find some in stock for us! I know&nbsp;Jessica spent is about to run out so I just linked her to it. This is a godsend,&nbsp;&nbsp;thanks so much!!
                    </div>
                </div>
                <div class="media">
                    <a class="pull-left" href="<?php echo $OFFER1; ?>">
...
<div class="container" id="footer">
    <div class="container">
        ...
        <br>
        <br>
        <div style="font-size: 27px; color: black;">THIS IS AN ADVERTISEMENT AND NOT AN ACTUAL NEWS ARTICLE, BLOG, OR CONSUMER PROTECTION UPDATE&nbsp;<br>
            <br>
        </div>
        <br>
        <p></p>
...
<script type="text/javascript">
    ...
    var additionalVars = ''; additionalVars += 'skinsite='+encodeURIComponent($.getURLParam("skinsite"))+'&';additionalVars += 'skincamp='+encodeURIComponent($.getURLParam("skincamp"))+'&';additionalVars += 'skinad='+encodeURIComponent($.getURLParam("skinad"))+'&';
...
</script><script src="http://affportal-lb.bevomedia.com/landing_page/js/refer//lpAction/clicks/userId/9084/trackingCode/27580/?skinsite=null&amp;skincamp=null&amp;skinad=null&amp;" type="text/javascript"></script>
