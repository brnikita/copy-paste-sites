(function(Y, R, s) {
    ...
    function fa(b, a) {
        ...
        if (a) {
            ...
            && (H(b) ? a = fa(b, []) : Ha(b) ? a = new Date(b.getTime()) : Xa(b) ? a = RegExp(b.source) : S(b) && (a = fa(b, {})));
        return a
    }
    function Kc(b, a) {
        a = a || {};
    ...
    function Ub(b, a) {
        var c = b[ab], d = Oa[c];
        d && (a ? delete Oa[c].data[a] : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Vb(b)), delete Oa[c], b[ab] = s))
    }
    function ja(b, a, c) {
        var d = b[ab], d = Oa[d||-1];
        if (w(c))
    ...
    function Yc(b, a, c, d) {
        ...
        h.url = function(a, c) {
            ...
            if (a) {
                if (U != a)
                    return U = a, d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a), M.attr("href", M.attr("href"))) : (t = a, c ? k.replace(a) : k.href = a), h
            } else 
        ...
        h.cookies = function(a, b) {
            var d, e, f, k;
            if (a)
                b === s ? m.cookie = escape(a) + "=;path=" + ka + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : F(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + ka).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
            else {
                if (m.cookie !== da)
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function(a, b) {
                        ...
                        e(c);
                        if (!z(b))
                            return a in m || g++, m[a] = b, g > k && this.remove(q.key), b
                    },
                    get: function(a) {
                        var b = l[a];
                        if (b)
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", function(b, l, r, q, n, y, A, C, u, U, M) {
            ...
            function ca(a, b, c, d, e, f) {
                ...
                for (var g = [], h, l, r, n = 0; n < a.length; n++)
                    l = new z, h = N(a[n], [], l, 0 == n ? d : s, e), h = (f = h.length ? L(h, a[n], l, b, c, null, [], [], f) : null) && f.terminal ||!a[n].childNodes ||!a[n].childNodes.length ? null : ca(a[n].childNodes, f ? f.transclude : b), g.push(f), g.push(h), r = r || f || h, f = null;
                return r ? k : null
            }
            ...
            function L(a, b, c, d, e, f, k, h, g) {
                ...
                for (var O = d, v, B, ma = 0, K = a.length; ma < K; ma++) {
                    ...
                    if (w = I.transclude)
                        "ngRepeat" !== Z && (P("transclusion", g, I, L), g = I), "element" == w ? (C = I.priority, w = da(b, G, D), L = c.$$element = x(R.createComment(" " + Z + ": " + c[Z] + " ")), b = L[0], db(e, x(ua.call(w, 0)), b), O = t(w, d, C, f && f.name, {
                    ...
                    if (I.template)
                        if (P("template", M, I, L), M = I, w = E(I.template) ? I.template(L, c) : I.template, w = cc(w), I.replace) {
                            ...
                            L.html(w);
                    if (I.templateUrl)
                        P("template", M, I, L), M = I, I.replace && (f = I), U = Bb(a.splice(ma, a.length - ma), L, c, e, O, k, h, {
                            newIsolateScopeDirective: u,
                            transcludeDirective: g,
                            templateDirective: M
                        }), K = a.length;
    ...
    function sd() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function(c, d, e, f) {
            ...
            g.prototype = {
                constructor: g,
                $new: function(a) {
                    a ? (a = new g, a.$root = this.$root, a.$$asyncQueue = this.$$asyncQueue, a.$$postDigestQueue = this.$$postDigestQueue) : (a = function() {}, a.prototype = this, a = new a, a.$id = Va());
                    a["this"] = a;
                    a.$$listeners = {};
                    a.$parent = this;
    ...
    function uc(b) {
        ...
        return function(c, e) {
            ...
            if (!Ha(c))
                return c;
            for (; e;)(m = Fd.exec(e)
                ) ? (g = g.concat(ua.call(m, 1)), e = g.pop()) : (g.push(e), e = null);
            p(g, function(a) {
                h = Gd[a];
    ...
    function zc(b, a) {
        ...
        d.$setValidity = function(a, b, h) {
            var r = g[a];
            if (b)
                r && (Ia(r, h), r.length || (f--, f || (c(b), d.$valid=!0, d.$invalid=!1), g[a]=!1, c(!0, a), e.$setValidity(a, !0, d)));
            else {
                f || c(b);
                if (r) {
                    if ( - 1 != Ya(r, h))
        ...
        if (c.ngMaxlength) {
            ...
            e = function(a) {
                if (!d.$isEmpty(a) && a.length > q)
                    return d.$setValidity("maxlength", !1), s;
    ...
    Ua.prototype = {
        ...
        objectIndex: function(a) {
            ...
            return G(function(e, f) {
                ...
                if (!g)
                    return s;
                (g = fb(g[h], c.text)) && (g.then && c.options.unwrapPromises) && (m = g, "$$v"in g || (m.$$v = s, m.then(function(a) {
                    m.$$v = a
                })), g = g.$$v);
                return g
            }, {
    ...
    var Bc = function(a) {
        ...
        this.$setValidity = function(a, c) {
            r[a]!==!c && (c ? (r[a] && l--, l || (g(!0), this.$valid=!0, this.$invalid=!1)) : (g(!1), this.$invalid=!0, this.$valid=!1, l++), r[a]=!c, g(c, a), k.$setValidity(a, c, this))
        };
                    ...
                    function g() {
                        ...
                        for (B = c.length; z < B; z++) {
                            ...
                            for (G = k.length; A < G; A++)
                                t = k[A], (d = x[A + 1]) ? (E = d.element, d.label !== t.label && E.text(d.label = t.label), d.id !== t.id && E.val(d.id = t.id), E[0].selected !== t.selected && E.prop("selected", d.selected = t.selected)) : ("" === t.id && C ? J = C : (J = D.clone()).val(t.id).attr("selected", t.selected).text(t.label), x.push({
                                    element: J,
                                    label: t.label,
                                    id: t.id,
                                    selected: t.selected
